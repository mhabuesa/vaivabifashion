  ...
  <div class="col-xxl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('storesubsubcategory') }}" method="POST">
            @csrf
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="subsubcategory_name" name="subsubcategory_name" placeholder="Electronics" />
            </div>
          </div>
